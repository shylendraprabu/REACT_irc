      ...
      <div className="form-box">
        ...
        {isLogin ? (
          <form className="input-group">
            ...
            <button type="submit" className="submit-btn" ><Link to="/Home1"><a href="." style={{ textDecoration: 'none' }}>
              Log In</a></Link></button>
          </form>
        ) : (
          <form className="input-group">
            <input type="text" className="input-field" placeholder="User Id" required />
            ...
            <button type="submit" className="submit-btn"><Link to="/Home1"><a href=".">
              Sign Up</a></Link></button>
          </form>
        )}
      </div>
    </div>
